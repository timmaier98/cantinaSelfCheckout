...
# # model = torch.hub.load("ultralytics/yolov5", "custom", path="trained_models_archive/yolov5s.pt")
...
# # model.load_state_dict(torch.load("trained_models_archive/yolov5s.pt", map_location=torch.device('cpu'))['model'].float().state_dict(), strict=False)
...
model = torch.hub.load("ultralytics/yolov5", "custom",
                       path="C:\\Users\\larsg\\PycharmProjects\\cantinaSelfCheckout\\Yolo\\trained_models_archive\\model_- 16 december 2022 23_16.pt",
                       force_reload=False)
while True:
