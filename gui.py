...
class Gui:
    def __init__(self):
        ...
        btn = tk.Button(master=self.frame_base, text='Confirm', width=8, height=2, font=font_buttons)
        ...
        self.cam_height = 680
        self.cam_width = 950
        self.image_label = tk.Label(self.frame_base, height=self.cam_height, width=self.cam_width, background=syscolor)
