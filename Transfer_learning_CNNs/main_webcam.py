...
def main():
    window_title = "Webcam"
    # network.initialize_model("trained_models_archive/own_data_with_none_class_fine_tuned.h5")
    network.initialize_model("Transfer_learning_CNNs/trained_models_archive/mensa_esen16_12_2022_14_29_fine_tuned.h5")
    while 1:
